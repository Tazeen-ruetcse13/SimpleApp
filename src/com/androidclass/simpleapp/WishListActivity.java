...
public class WishListActivity extends Activity {
	...
	private void initializeAll() {
		...
		wishEditText = (EditText) findViewById(R.id.wishEditText);
		...
		adapter = new BaseAdapter() {
			...
			public View getView(int position, View view, ViewGroup viewGroup) {
				...
				wishListItemTextView.setText(arrayList.get(position).getWishString());
				
				Date date = arrayList.get(position).getDate();
				wishListDateTextView.setText(DateFormat.format("dd/MM/yyyy HH:mm:ss a", date));
		...
		addWishButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getBaseContext(), "Wish Added", Toast.LENGTH_SHORT).show();
		...
		wishListView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View view,
				...
				Toast.makeText(getBaseContext(), "One Wish Removed", Toast.LENGTH_SHORT).show();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_wish_list, menu);
		return true;
	}
